...
ChainPropertySetting::ChainPropertySetting(EditPanel* editPanel, ChainShape* chain)
	: IPropertySetting(editPanel, wxT("Chain"))
	, m_chain(chain)
{
}

void ChainPropertySetting::updatePanel(PropertySettingPanel* panel)
{
...
void ChainPropertySetting::updatePropertyGrid(PropertySettingPanel* panel)
{
	updatePanel(panel);
}

void ChainPropertySetting::enablePropertyGrid(PropertySettingPanel* panel, bool bEnable)
{
	wxPropertyGrid* pg = panel->getPG();
